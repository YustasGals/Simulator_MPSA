        ...
        private static void Items_CollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            switch (e.Action)
            {
                case System.Collections.Specialized.NotifyCollectionChangedAction.Add:
                    ...
                    LogWriter.LogWriteLine("Добавлен сигнал DI: " + (e.NewItems[0] as DIStruct).NameDI + Environment.NewLine);
                    break;
                ...
                case System.Collections.Specialized.NotifyCollectionChangedAction.Remove:
                    ...
                    LogWriter.LogWriteLine("Удален сигнал DI: " + (e.OldItems[0] as DIStruct).NameDI + Environment.NewLine);
